    ...
    <div className="min-h-full py-4 flex items-center justify-center   px-3">
      ...
      <div className="w-full max-w-4xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4">
          <GlassBadge variant="default" className="mb-2 text-black">
            <Sparkles className="size-3 mr-1" /> Simple Pricing
          </GlassBadge>
          <h1 className="text-3xl lg:text-4xl font-bold text-black">اشتراک مورد نیاز خود را انتخاب کنید</h1>
        ...
        <div className="flex justify-center items-center gap-4">
          <span
            className={`text-sm transition-colors ${!isYearly ? "text-black" : "text-white"}`}
          >
            ماهانه
          </span>
          ...
          >
            سالانه
            <GlassBadge variant="success" className="ml-2 text-xs text-green">
               تخفیف %20
            </GlassBadge>
          </span>
        </div>
